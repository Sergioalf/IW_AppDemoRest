...
import bd from '../models/personas.model';
...
exports.Get = async (req,res) => {
    GET(res,bd,name[0],{IdPersona: req.params.id})
};

exports.Put = async (req,res) => {
    req.body.FechaUltMod = FORMATS_FOR_DATE_AND_TIME().DATE_UTC;
    PUT(res,bd,name[0],{IdPersona: req.params.id},req.body);
};

exports.Delete = async (req,res) => {
    DELETE(res,bd,name[0],{IdPersona: req.params.id});
};